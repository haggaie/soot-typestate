 ...
 * generated
 */
public class AutomataExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {

	private Logger log = Logger.getLogger(AutomataExecutableExtensionFactory.class);
	...
	public Object create() throws CoreException {
		soot.typestate.automata.internal.AutomataActivator instance = soot.typestate.automata.internal.AutomataActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = soot.typestate.automata.internal.AutomataActivator.getInstance().getInjector("soot.typestate.automata.Automata");
