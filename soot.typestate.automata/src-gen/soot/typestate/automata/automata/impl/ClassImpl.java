 ...
 * <ul>
 *   <li>{@link soot.typestate.automata.automata.impl.ClassImpl#getStates <em>States</em>}</li>
 ...
 * @generated
 */
public class ClassImpl extends AutomatonImpl implements soot.typestate.automata.automata.Class
{
  /**
  ...
  public EList<State> getStates()
  {
    if (states == null)
    {
      states = new EObjectContainmentEList<State>(State.class, this, AutomataPackage.CLASS__STATES);
    }
    return states;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AutomataPackage.CLASS__STATES:
